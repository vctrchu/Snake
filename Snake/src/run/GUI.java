...
/**
 * GUI Code for Snake Game Project Based off of DrawingApp.java by Nathaly Verwaal used in Team Assignment 5
 *
...
public class GUI extends JFrame implements ActionListener, KeyListener {
	...
	public void timerAction() {
		...
		highscore.setText("<html><u>High Score</u><br>Score: <html>" + HighScoreManager.getHighScore());
		repaint();
	}
	...
	/**
	 * Checks if the button to close to the main menu is clicked.  If clicked, then
	 * the GUI window is hidden.  It will also read and write to the high score file
	 * to check if a new high score was set.
	 * @param e
	 */
	@Override
	public void actionPerformed(ActionEvent e) {
	...
	/**
	 * generates a random rgb value. Mainly utilized for background colors
	 * @return int
	 */
	...
	public void keyTyped(KeyEvent e) {
		// Required for import. Does nothing here.
